...
* Using **[VirtualSMC](https://github.com/acidanthera/virtualsmc/releases)** instead of FakeSMC and [ACPIBatteryManager.kext](https://bitbucket.org/RehabMan/os-x-acpi-battery-driver/downloads/) *(no battery related DSDT patch has been applied)*
